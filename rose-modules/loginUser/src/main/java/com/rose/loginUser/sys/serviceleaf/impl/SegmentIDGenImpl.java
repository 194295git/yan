...
import com.rose.loginUser.sys.dao.IDAllocMapper;
...
public class SegmentIDGenImpl implements IDGen {
    ...
    private LeafAlloc updateMaxIdAndGetLeafAlloc(String key){
        ...
        dao.updateMaxId( key);
        LeafAlloc result =dao.getLeafAlloc(key);
        return result;
    }
...
//    }
    ...
    private LeafAlloc updateMaxIdByCustomStepAndGetLeafAlloc(LeafAlloc temp){
        ...
        dao.updateMaxIdByCustomStep(temp);
        LeafAlloc result = dao.getLeafAlloc( temp.getKey());
        return result;
