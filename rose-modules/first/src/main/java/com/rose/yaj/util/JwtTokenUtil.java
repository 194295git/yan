...
public class JwtTokenUtil {
     ...
     * @return
     */
//    public static String generateToken(YanUser user) {
//        return Jwts.builder()
...
//    }
     ...
     * 创建jwt
     */
    public static String generateToken(YanUser user) throws Exception {
    ...
    public void test() throws Exception {
        ...
        String openid = "BEE8E17A7A794A979211DE3C4590824E";

        user.setOpenid(openid);
        user.setUsername("todo-1");
        // 检验当前是否用户是否存在
        String token = JwtTokenUtil.generateToken(user);
        System.out.println(token);
        Claims claims = parseJWT(token);
        String openid1 = (String) claims.get("openid");
