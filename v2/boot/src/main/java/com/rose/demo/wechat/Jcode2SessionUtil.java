...
public class Jcode2SessionUtil {
    ...
    public static String jscode2session(String appid, String secret, String code, String grantType) throws Exception {
        ...
        System.out.println("===========Jcode2Session================="+code);

        System.out.println("===========execute(httpPost).getEntity())=================");
        String rep =EntityUtils.toString(new DefaultHttpClient().execute(httpPost).getEntity());
